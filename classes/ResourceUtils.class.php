...
class ResourceUtils
{
	...
	function __construct()
	{
 	...
 	function getData($strResource = null,$intResourceID = null,$strSecondResource = null,$arrVariables = null)
 	{
 		...
 		if ($strSecondResource)
 		{
 			$strSecondResource					= 'get' . $strSecondResource . 'Array';
 			
 			// DO WE HAVE A METHOD FOR THIS RESOURCE
 			if (method_exists($objData,$strSecondResource))
 			{
 				$objSecondaryResource			= $objData->$strSecondResource($arrVariables);
